...
public class TinyDB {
    ...
    public ArrayList<Upgrade> getListObject(String key, Class<Upgrade> mClass){
    	...
    	ArrayList<Upgrade> objects =  new ArrayList<Upgrade>();

    	for(String jObjString : objStrings){
    		Upgrade value  = gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<Upgrade> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
